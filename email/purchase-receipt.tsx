        ...
        <Body className="font-sans bg-white">
          <Container className="max-w-xl">
            ...
            <Section>
              <Row>
                <Column>
                  <Text className="mb-0 mr-4 text-gray-50 whitespace-nowrap text-nowrap">
                    Order ID
                  </Text>
            ...
            <Section className="border-solid border-gray-500 rounded-lg p-4 md:p-6 my-4">
                {order.orderitems.map((item) => (
                    <Row key={item.productId} className="mt-8">
                        ...
                        <Column align="right" className="align-top">{formatCurrency(item.price)}</Column>
                    </Row>
                ))}
                {[
